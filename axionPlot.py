...
class AxionGagPlot:
    ...
    def __init__(
        self, plottype="large_panorama", projections=False, showplot=True, saveplot=True
    ):
    ...
    def PlotLabels(self, plottype, projections=False):
        ...
        if plottype == "panorama":
            ...
            plt.text(
                5e-6, 1e-13, r"{\bf Haloscopes}", color="black", size=11, ha="center"
            )
        ...
        if plottype == "haloscopes":
            ...
            plt.text(
                7e-6, 0.86, "ADMX", color="black", size=10, ha="center", va="center"
            )
            plt.text(
                1.9e-5, 2.24, "CAPP", color="black", size=10, ha="center", va="center"
            )
            plt.text(
                1.46e-5,
                25,
            ...
            plt.text(
                1.2e-4, 1.15, "MADMAX", color="black", size=8, ha="center", va="center"
            )
            plt.text(
                1.2e-4, 30, "ORGAN", color="black", size=8, ha="center", va="center"
            )
            plt.text(
                3e-5,
                25,
...
class AxionGaePlot:
    ...
    #
    def __init__(
        self, plottype="helioscopes", projections=False, showplot=True, saveplot=True
    ):
        figx = 6
        figy = 5
        ...
        self.axplot = BasePlot(
            xlab="$m_a$ (eV)",
            ylab=r"$|g_{ae}g_{a\gamma}|^{1/2}$ (GeV$^{-1/2}$)",
            figsizex=figx,
            figsizey=figy,
            y_min=1.0e-13,
            y_max=1.0e-10,
...
def BuildDB():
    db = {}
    path = "data/axion/"
    db["qcdband"] = ExPltItem(
        "qcdband", "band", path + "QCD_band.dat", facecolor="yellow"
    )
    db["ksvz"] = ExPltItem(
        "ksvz",
        "region",
    ...
    db["old_haloscopes"] = ExPltItem(
        "old_haloscopes",
        "band",
        path + "MicrowaveCavities.txt",
        facecolor="limegreen",
        edgecolor="darkgreen",
        linewidth=0.2,
    )
    ...
    db["admx_hf_2016"] = ExPltItem(
        "haystack",
        "band",
        path + "admx_hf_2016.dat",
        facecolor="limegreen",
        edgecolor="darkgreen",
        linewidth=0.2,
    )
    db["ADMX2018"] = ExPltItem(
        "ADMX2018",
        "band",
        path + "ADMX2018.txt",
        facecolor="limegreen",
    ...
    db["ADMX_sidecar"] = ExPltItem(
        "ADMX_sidecar",
        "band",
        path + "ADMX_sidecar.txt",
        facecolor="limegreen",
        edgecolor="darkgreen",
        linewidth=0.2,
    )
    db["ADMX2021"] = ExPltItem(
        "ADMX2021",
        "band",
        path + "ADMX2021.txt",
        facecolor="limegreen",
    ...
    db["CAPP_multicell"] = ExPltItem(
        "CAPP_multicell_2020",
        "band",
        path + "CAPP_multicell_2020.dat",
        facecolor="limegreen",
        edgecolor="darkgreen",
        linewidth=0.2,
    )
    db["CAPP2021"] = ExPltItem(
        "CAPP2021",
        "band",
        path + "CAPP2021.txt",
        facecolor="limegreen",
    ...
    db["HAYSTAC2020"] = ExPltItem(
        "haystack2020",
        "band",
        path + "haystac2020.txt",
        facecolor="limegreen",
        edgecolor="darkgreen",
        linewidth=0.2,
    )
    ...
    db["sn1987a_photon"] = ExPltItem(
        "sn1987a_photon",
        "band",
        path + "sn1987a_photon.dat",
        facecolor="turquoise",
        edgecolor="darkgreen",
        linewidth=0.5,
    )
    db["FERMI_NG1275"] = ExPltItem(
        "FERMI_NG1275_region",
        "region",
        path + "FERMI_NG1275_region.dat",
        facecolor="mediumturquoise",
        edgecolor="darkgreen",
        linewidth=0.5,
        alpha=0.6,
    ...
    db["SN1987energyloss"] = ExPltItem(
        "SN1987energyloss",
        "band",
        path + "cosmoalp/SN1987energyloss.txt",
    ...
    db["Xray"] = ExPltItem(
        "Xray",
        "band",
        path + "cosmoalp/Xray.txt",
        facecolor="green",
        edgecolor="darkgreen",
        linewidth=0.5,
    )
    db["Deut2016"] = ExPltItem(
        "Deut2016",
        "region",
        path + "cosmoalp/Deut2016.txt",
        facecolor="limegreen",
        edgecolor="darkgreen",
        linewidth=0.5,
    )
    db["OpticalDepthTerm"] = ExPltItem(
        "OpticalDepthTerm",
        "band",
        path + "cosmoalp/OpticalDepthTerm.txt",
    ...
    db["cmb_mu"] = ExPltItem(
        "cmb_mu",
        "region",
        path + "cosmoalp/CMB_mu.txt",
        facecolor="green",
        edgecolor="darkgreen",
        linewidth=0.5,
    )
    db["CMB_DEsuE"] = ExPltItem(
        "CMB_DEsuE",
        "band",
        path + "cosmoalp/CMB_DEsuE.txt",
        facecolor="forestgreen",
        edgecolor="darkgreen",
        linewidth=0.5,
    )
    db["Overduin"] = ExPltItem(
        "Overduin",
        "region",
        path + "cosmoalp/Overduin.txt",
        facecolor="lightgreen",
        edgecolor="green",
        linewidth=0.5,
    )
    db["Ressell"] = ExPltItem(
        "Ressell",
        "band",
        path + "cosmoalp/Ressell.txt",
        facecolor="lightgreen",
        edgecolor="green",
        linewidth=0.5,
    )
    db["endlist2_gamma_projimprov"] = ExPltItem(
        "endlist2_gamma_projimprov",
        "band",
        path + "endlist2_gamma_projimprov.txt",
        facecolor="gray",
        edgecolor="black",
        linewidth=0.5,
    )

    db["telescopes"] = ExPltItem(
        "telescopes",
        "band",
        path + "telescopes.dat",
        facecolor="green",
    ...
    db["telescopes_new"] = ExPltItem(
        "telescopes_new",
        "band",
        path + "telescopes_new.dat",
        facecolor="green",
        edgecolor="darkgreen",
        linewidth=0.5,
    )

    db["HBalpbound"] = ExPltItem(
        "HBalpbound",
        "band",
        path + "HBalpbound.txt",
        facecolor="skyblue",
    ...
    db["HBalpbound_l"] = ExPltItem(
        "HBalpbound_l", "line", path + "HBalpbound.txt", color="blue", linewidth=0.5
    )
    db["solar_nu"] = ExPltItem(
        "solar_nu",
        "band",
        path + "ALPSun_nu.txt",
        facecolor="steelblue",
    ...
    db["IAXO"] = ExPltItem(
        "IAXO",
        "band",
        path + "IAXO_nominal.txt",
        facecolor="deepskyblue",
        linewidth=0.5,
        alpha=0.1,
        linestyle="-",
    )
    db["IAXOplus"] = ExPltItem(
        "IAXOplus",
        "band",
        path + "IAXO_plus.txt",
        facecolor="deepskyblue",
    ...
    db["ADMXprosp_2GHz"] = ExPltItem(
        "ADMXprosp_2GHz",
        "band",
        path + "ADMX_prospects_2GHz.dat",
        facecolor="limegreen",
        edgecolor="black",
        linewidth=0.1,
        alpha=0.1,
    ...
    db["ADMXprosp_10GHz"] = ExPltItem(
        "ADMXprosp_10GHz",
        "band",
        path + "ADMX_prospects_10GHz.dat",
        facecolor="limegreen",
        edgecolor="black",
        linewidth=0.1,
        alpha=0.1,
    ...
    db["KLASH"] = ExPltItem(
        "KLASH", "line", path + "KLASH.dat", color="green", linewidth=0.1, linestyle="-"
    )
    db["TOORAD"] = ExPltItem(
        "TOORAD",
        "line",
    ...
    db["BRASS"] = ExPltItem(
        "BRASS", "line", path + "BRASS.txt", color="green", linewidth=0.1, linestyle="-"
    )
    db["IAXODM"] = ExPltItem(
        "IAXODM.dat",
        "band",
    ...
    db["ADMXprosp_10GHz_l"] = ExPltItem(
        "ADMXprosp_10GHz",
        "line",
        path + "ADMX_prospects_10GHz.dat",
        color="darkgreen",
    ...
    db["AMELIE"] = ExPltItem(
        "AMELIE",
        "line",
        path + "amelie_1m3_arXiv_1508.03006.txt",
        color="gray",
        linewidth=0.6,
        alpha=1,
        linestyle="--",
    ...
    db["THintCIBER"] = ExPltItem(
        "THintCIBER",
        "region",
        path + "CIBER_contour_data.dat",
        facecolor="yellow",
        edgecolor="orange",
        linewidth=0.5,
    )
...
def BuildGaeDB():
    ...
    db["AJ83_starhint"] = ExPltItem(
        "AJ83_starhint",
        "region",
        path + "AJ83_ABC_dominant_No_SN_2sigma_hint_rootgaegag_vs_ma.dat",
        facecolor="red",
        edgecolor="red",
        alpha=0.2,
    )
    ...
    db["IAXO_gae"] = ExPltItem(
        "IAXO",
        "band",
        path + "sqrtgaagae_sc2.dat",
        facecolor="skyblue",
        edgecolor="black",
        linewidth=0.5,
        alpha=0.3,
    )
    db["IAXOplus_gae"] = ExPltItem(
        "IAXOplus",
        "band",
        path + "sqrtgaagae_sc3.dat",
        facecolor="skyblue",
        edgecolor="black",
        linewidth=0.5,
        alpha=0.3,
    )
    db["CAST_gae"] = ExPltItem(
        "CAST",
        "band",
        path + "CAST_gae_gagg.dat",
        facecolor="steelblue",
        edgecolor="darkblue",
        linewidth=0.5,
    )
    db["IAXO_gae_l"] = ExPltItem(
        "IAXO",
        "line",
        path + "sqrtgaagae_sc2.dat",
        color="black",
