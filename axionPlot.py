...
class AxionGagPlot:
    ...
    def __init__(self,plottype="large_panorama",projections=False,showplot=True,saveplot=True):
        ...
        self.ListOfPlotTypes = {'large_panorama', 'panorama','LSWexps','haloscopes','haloscopes_zoom','haloscopes_radeszoom','helioscopes'}
        ...
        figx=6.5; figy=5; ymin=1e-18; ymax=1e-4; xmin=1e-11; xmax=1e9
        ticksopt_x = 'dense'; ticksopt_y = 'normal'
        labelx='$m_a$ (eV)'; labely = r'$|g_{a\gamma}|$ (GeV$^{-1}$)'

        if (plottype == "panorama"):
            figx=6.5; figy=6; ymin=1e-17; ymax=1e-6; xmin=1e-9; xmax=10
            ticksopt_x = 'normal'; ticksopt_y = 'normal'

        if (plottype == "helioscopes"):
            figx=8; figy=6; ymin=1e-13; ymax=1e-8; xmin=1e-11; xmax=1
            ticksopt_x = 'normal'; ticksopt_y = 'normal'

        if (plottype == "LSWexps"):
            figx=6.5; figy=5; ymin=1e-13; ymax=1e-6; xmin=1e-10; xmax=1e-2
            ticksopt_x = 'normal'; ticksopt_y = 'normal'

        if (plottype in ["haloscopes","haloscopes_zoom","haloscopes_radeszoom"]):
            figx=8; figy=5; ymin=1e-1; ymax=1e3; xmin=1e-9; xmax=1
            if (plottype in ["haloscopes_zoom"]):
                 xmin=3e-7; xmax=3e-2
            if (plottype in ["haloscopes_radeszoom"]):
                 xmin=3.4e-5; xmax=4.5e-5
            ticksopt_x = 'normal'; ticksopt_y = 'normal'
    ...
    def PlotData(self,plottype,projections=False):
        ...
        if (plottype in ["haloscopes","haloscopes_zoom","haloscopes_radeszoom"]):
            ...
            for item in ['qcdband','ksvz',
                    ...
                    'CAPP-8TB','CAPP_multicell','CAPP2021','HAYSTAC','HAYSTAC2020','ORGAN','QUAX','QUAX2021','ADMX_SLIC',
                    'RADES2021','admx','CAST']:
...
def BuildDB():
    ...
    db['ADMX2019'] = ExPltItem("ADMX2019","band", path+"ADMX2019.dat",facecolor="limegreen",edgecolor="darkgreen",linewidth=0.2)
    ...
    db['CAPP_multicell'] = ExPltItem("CAPP_multicell_2020","band", path+"CAPP_multicell_2020.dat",facecolor="limegreen",edgecolor="darkgreen",linewidth=0.2)
    db['CAPP2021'] = ExPltItem("CAPP2021","band", path+"CAPP2021.txt",facecolor="limegreen",edgecolor="darkgreen",linewidth=0.2)
    db['HAYSTAC'] = ExPltItem("HAYSTAC","band", path+"HAYSTAC.txt",facecolor="limegreen",edgecolor="darkgreen",linewidth=0.2)
    db['HAYSTAC2020'] = ExPltItem("haystack2020","band", path+"haystac2020.txt",facecolor="limegreen",edgecolor="darkgreen",linewidth=0.2)
    ...
    db['QUAX2021'] = ExPltItem("QUAX","band", path+"QUAX2021.txt",facecolor="limegreen",edgecolor="darkgreen",linewidth=0.2)
    db['RADES2021'] = ExPltItem("RADES2021","band", path+"RADES2021.txt",facecolor="limegreen",edgecolor="darkgreen",linewidth=0.2)

    db['ABRA10cm'] = ExPltItem("ABRA10cm","band", path+"ABRA10cm.txt",facecolor="limegreen",edgecolor="darkgreen",linewidth=0.5,alpha=0.5)
    db['ABRA_2021'] = ExPltItem("ABRA_2021","band", path+"ABRA_2021.txt",facecolor="limegreen",edgecolor="darkgreen",linewidth=0.5,alpha=0.5)
    db['BASE_2021'] = ExPltItem("BASE2021","band", path+"BASE2021.txt",facecolor="limegreen",edgecolor="darkgreen",linewidth=0.5,alpha=0.5)
    db['ADMX_SLIC'] = ExPltItem("ADMX_SLIC","band", path+"ADMX_SLIC.txt",facecolor="limegreen",edgecolor="darkgreen",linewidth=0.5,alpha=0.5)
    ...
    db['mrk421'] = ExPltItem('mrk421','band',path+'Mrk421.txt',facecolor="mediumturquoise",edgecolor="darkgreen", linewidth=0.5, alpha=0.6)
    ...
    #projecions
    db['BabyIAXO'] = ExPltItem('BAbyIAXO','band',path+'miniIAXO.dat',facecolor="deepskyblue", linewidth=0.5, alpha=0.1, linestyle="-")
    db['IAXO'] = ExPltItem('IAXO','band',path+'IAXO_nominal.txt', facecolor="deepskyblue",linewidth=0.5, alpha=0.1, linestyle="-")
    db['IAXOplus'] = ExPltItem('IAXOplus','band',path+'IAXO_plus.txt',facecolor="deepskyblue", linewidth=0.5, alpha=0.1, linestyle="-")
    ...
    #"only_line" versions
    db['BabyIAXO_l'] = ExPltItem('BAbyIAXO','line',path+'miniIAXO.dat',color="black", linewidth=0.6, alpha=1, linestyle="--")
    db['IAXO_l'] = ExPltItem('IAXO','line',path+'IAXO_nominal.txt', color="black",linewidth=0.6, alpha=1, linestyle="--")
    db['IAXOplus_l'] = ExPltItem('IAXOplus','line',path+'IAXO_plus.txt',color="black", linewidth=0.6, alpha=1, linestyle="--")
    ...
    db['MADMAX_l'] = ExPltItem('MADMAX','line',path+'MADMAX.dat',color="darkgreen",linewidth=0.3, alpha=1, linestyle="--")
    db['ADMXprosp_2GHz_l'] = ExPltItem('ADMXprosp_2GHz','line',path+'admx_prospects_2ghz.dat',color="darkgreen",linewidth=0.3, alpha=1, linestyle="--")
    db['ADMXprosp_10GHz_l'] = ExPltItem('ADMXprosp_10GHz','line',path+'ADMX_prospects_10GHz.dat',color="darkgreen",linewidth=0.3, alpha=1, linestyle="--")
    db['ABRA1_l'] = ExPltItem('ABRA1','line',path+'ABRAres_1.dat',color="darkgreen",linewidth=0.1, alpha=1, linestyle="--")
    db['ABRA_2021_l'] = ExPltItem('ABRA_2021','line',path+'ABRA_2021.txt',color="darkgreen",linewidth=0.1, alpha=1, linestyle="--")
    ...
    db['HBhint'] = ExPltItem('HBhint','region',path+'hints/HB_hint.dat',facecolor='none',edgecolor='orangered', linewidth=0.3, linestyle='-',hatch='////')
...
def BuildGaeDB():
    ...
    db['DFSZ1_starhint'] = ExPltItem("DFSZ1_starhint","region",path+"DFSZ1_ABC_dominant_No_SN_2sigma_hint_rootgaegag_vs_ma.dat",facecolor="springgreen",edgecolor="darkgreen",alpha=0.2)
    db['DFSZ2_starhint'] = ExPltItem("DFSZ2_starhint","region",path+"DFSZ2_ABC_dominant_No_SN_2sigma_hint_rootgaegag_vs_ma.dat",facecolor="lime",edgecolor="darkgreen",alpha=0.2)
    db['AJ23_starhint'] = ExPltItem("AJ23_starhint","region",path+"AJ23_ABC_dominant_No_SN_2sigma_hint_rootgaegag_vs_ma.dat",facecolor="orange",edgecolor="red",alpha=0.2)
    db['AJ53_starhint'] = ExPltItem("AJ53_starhint","region",path+"AJ53_ABC_dominant_No_SN_2sigma_hint_rootgaegag_vs_ma.dat",facecolor="yellow",edgecolor="orange",alpha=0.2)
    db['AJ83_starhint'] = ExPltItem("AJ83_starhint","region",path+"AJ83_ABC_dominant_No_SN_2sigma_hint_rootgaegag_vs_ma.dat",facecolor="red",edgecolor="red",alpha=0.2)

    path="data/axion/gaegag/"
    db['QCDband'] = ExPltItem("QCDband","band",path+"DFSZband_gaegag.dat",facecolor="lemonchiffon",edgecolor="none",linewidth=1)
    #db['BabyIAXO'] = ExPltItem("BabyIAXO","band",path+"miniIAXO_gae_gag.dat",facecolor="white",edgecolor="orange",linewidth=1)
    db['IAXO_gae'] = ExPltItem("IAXO","band", path+"sqrtgaagae_sc2.dat",facecolor="skyblue",edgecolor="black",linewidth=0.5,alpha=0.3)
    db['IAXOplus_gae'] = ExPltItem("IAXOplus","band", path+"sqrtgaagae_sc3.dat",facecolor="skyblue",edgecolor="black",linewidth=0.5,alpha=0.3)
    db['CAST_gae'] = ExPltItem("CAST","band", path+"CAST_gae_gagg.dat",facecolor="steelblue",edgecolor="darkblue",linewidth=0.5)
    db['IAXO_gae_l'] = ExPltItem("IAXO","line", path+"sqrtgaagae_sc2.dat",color="black",linewidth=0.5,linestyle='--')
    db['IAXOplus_gae_l'] = ExPltItem("IAXOplus","line", path+"sqrtgaagae_sc3.dat",color="black",linewidth=0.5,linestyle='--')
