...
AxionsGag = [
    ...
    # STELLAR - HELIOSCOPES
    ['CAST', 'band', path + 'cast_env_2016.dat', "facecolor='deepskyblue', edgecolor='blue', linewidth=0.5", 0, '', '', 0, 0, 0, 0, 1, 1, 0, 0], #Up to Nature paper (2017)
    ['CAST2021', 'band', path + 'CAST_2019_2021_PRL.txt', "facecolor='deepskyblue', edgecolor='blue', linewidth=0.5", 0, '', '', 0, 0, 0, 0, 1, 1, 0, 0], #Legacy results of all the data up to 2021.
