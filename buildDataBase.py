...
print(
    "If it already exists, the table will be appended. Note this can cause to have duplicated rows."
)
...
AxionsGag = [
    ...
    [
        ...
        "region",
        path + "ksvz.dat",
        "facecolor='white', edgecolor='orange', linewidth=1",
        1,
        1,
        1,
        1,
    ...
    [
        ...
        "band",
        path + "ABRA10cm.txt",
        "facecolor='limegreen', edgecolor='darkgreen', linewidth=0.5, alpha=0.5",
        0,
        0,
        0,
        0,
    ...
    [
        ...
        "band",
        path + "ADMX_SLIC.txt",
        "facecolor='limegreen', edgecolor='darkgreen', linewidth=0.5, alpha=1",
        1,
        1,
        1,
        1,
    ...
    [
        ...
        "band",
        path + "hess.dat",
        "facecolor='lightseagreen', edgecolor='darkgreen', linewidth=0.5",
        1,
        1,
        1,
        1,
    ...
    [
        ...
        "facecolor='turquoise', edgecolor='darkgreen', linewidth=0.5",
        1,
        1,
        1,
        1,
    ...
    [
        ...
        "facecolor='forestgreen', edgecolor='darkgreen', linewidth=0.5",
        1,
        1,
        0,
        0,
    ...
    [
        ...
        "band",
        path + "HBalpbound.txt",
        "facecolor='skyblue', edgecolor='blue', alpha=1, linewidth=0.5",
        1,
        1,
        1,
        1,
    ...
    [
        ...
        "band",
        path + "ALPSun_nu.txt",
        "facecolor='steelblue', edgecolor='blue', linewidth=0.5",
        1,
        1,
        1,
        0,
    ...
    [
        ...
        "facecolor='deepskyblue', edgecolor='blue', linewidth=0.5",
        1,
        1,
        1,
        0,
    ...
    [
        ...
        "band",
        path + "CROWS.txt",
        "facecolor='gray', edgecolor='white', linewidth=0.5",
        1,
        1,
        1,
        0,
    ...
    [
        ...
        "band",
        path + "miniIAXO.dat",
        "facecolor='deepskyblue', linewidth=0.5, alpha=0.1, linestyle='-'",
        1,
        1,
        1,
        0,
    ...
    [
        ...
        "band",
        path + "ALPSII.dat",
        "facecolor='gray', linewidth=0.5, alpha=0.2, linestyle=':'",
        1,
        1,
        1,
        0,
    ...
    [
        ...
        "line",
        path + "ORGAN2.dat",
        "color='darkgreen', linewidth=0.1, linestyle='-'",
        1,
        1,
        0,
        0,
    ...
    [
        ...
        "line",
        path + "ABRAres_1.dat",
        "color='green', linewidth=0.1, linestyle='-'",
        0,
        0,
        1,
        0,
    ...
    [
        ...
        "line",
        path + "miniIAXO.dat",
        "color='black', linewidth=0.6, alpha=1, linestyle='--'",
        0,
        0,
        0,
        0,
    ...
    [
        ...
        "line",
        path + "ALPSII.dat",
        "color='black', linewidth=0.5, alpha=1, linestyle=':'",
        0,
        0,
        0,
        0,
    ...
    [
        ...
        "line",
        path + "CAPP4.dat",
        "color='darkgreen', linewidth=0.1, alpha=1, linestyle='--'",
        1,
        1,
        1,
        1,
    ...
    [
        ...
        "line",
        path + "MADMAX.dat",
        "color='darkgreen', linewidth=0.3, alpha=1, linestyle='--'",
        0,
        0,
        1,
        1,
    ...
    [
        ...
        "color='gray', linewidth=0.6, alpha=1, linestyle='--'",
        1,
        1,
        1,
        1,
    ...
    [
        ...
        "region",
        path + "Mayer_2013.dat",
        "facecolor='yellow', edgecolor='orange', linewidth=0.5",
        0,
        0,
        1,
        1,
    ...
    [
        ...
        "facecolor='none', edgecolor='orangered', linewidth=0.3, linestyle='-', hatch='////'",
        1,
        1,
        0,
        0,
...
AxionsGae = [
    [
        "DFSZ1_starhint",
        "region",
        path1 + "DFSZ1_ABC_dominant_No_SN_2sigma_hint_rootgaegag_vs_ma.dat",
    ...
    [
        "DFSZ2_starhint",
        "region",
        path1 + "DFSZ2_ABC_dominant_No_SN_2sigma_hint_rootgaegag_vs_ma.dat",
    ...
    [
        "AJ23_starhint",
        "region",
        path1 + "AJ23_ABC_dominant_No_SN_2sigma_hint_rootgaegag_vs_ma.dat",
    ...
    [
        "AJ53_starhint",
        "region",
        path1 + "AJ53_ABC_dominant_No_SN_2sigma_hint_rootgaegag_vs_ma.dat",
    ...
    [
        "AJ83_starhint",
        "region",
        path1 + "AJ83_ABC_dominant_No_SN_2sigma_hint_rootgaegag_vs_ma.dat",
        "facecolor='red', edgecolor='red', alpha=0.2",
        1,
        0,
    ],
    [
        "QCDband",
        "band",
        path2 + "DFSZband_gaegag.dat",
        "facecolor='lemonchiffon', edgecolor='none', linewidth=1",
        1,
        0,
    ],
    [
        "CAST_gae",
        "band",
        path2 + "CAST_gae_gagg.dat",
        "facecolor='steelblue', edgecolor='darkblue', linewidth=0.5",
        1,
        0,
    ],
    [
        "IAXO_gae",
        "band",
        path2 + "sqrtgaagae_sc2.dat",
        "facecolor='skyblue', edgecolor='black', linewidth=0.5, alpha=0.3",
        0,
        1,
    ],
    [
...
large_panorama = [
    ...
    [
        ...
        2e2,
        1.6e-10,
        " color='black', size=7, va='center', ha='center'",
        1,
        0,
    ],
    ...
    [
        ...
        1.5e7,
        5e-6,
        " color='white', size=8, rotation=-45, ha='center', va='center'",
        1,
        0,
    ],
    [
        ...
        1e4,
        3e-17,
        " color='white', size=10, rotation=-57, ha='center', va='center'",
        1,
        0,
    ],
    ...
    [
        ...
        1e5,
        1e-14,
        " color='black', size=9, rotation=-57, ha='center', va='center'",
        1,
        0,
    ],
    [
        ...
        2e8,
        1e-14,
        " color='white', size=9, rotation=-57, ha='center', va='center'",
        1,
        0,
    ],
    [
        ...
        3e7,
        1e-10,
        " color='black', size=10, rotation=-57, ha='center', va='center'",
        1,
        0,
    ],
    [
        ...
        1e2,
        1e-13,
        " color='black', size=8, ha='center', va='center', rotation=90",
        1,
        0,
    ],
    ...
    [
        ...
        2.9e-6,
        3e-13,
        " color='black', size=6, ha='center', va='center', rotation=90",
        1,
        0,
    ],
    [
        ...
        8.3e-6,
        3.5e-12,
        " color='black', size=5, ha='center', va='center', rotation=90",
        1,
        0,
    ],
    [
        ...
        1.3e-5,
        2.5e-14,
        " color='black', size=4, ha='center', va='center', rotation=90",
        1,
        0,
    ],
    ...
    [
        ...
        8e-6,
        2e-16,
        " color='black', size=5, ha='center', va='center', rotation=47",
        1,
        1,
    ],
    [
    ...
    [
        ...
        7e-9,
        4e-15,
        " color='black', size=6, ha='center', va='center'",
        1,
        1,
    ],
    # ===========================================================================#
...
panorama = [
    ...
    [
        ...
        2e-3,
        2.5e-11,
        " color='black', size=10, ha='center', va='center'",
        1,
        1,
    ],
    [
...
haloscopes = [
    [
        ...
        2.5e-3,
        110,
        " color='black', size=12, ha='center', rotation=-57",
        1,
        0,
    ],
    [
    ...
    [
        ...
        3.3e-7,
        70,
        " color='black', size=11, ha='center', va='center', rotation=90",
        1,
        0,
    ],
    ...
    [
        ...
        2.9e-6,
        70,
        " color='black', size=12, ha='center', va='center', rotation=90",
        1,
        0,
    ],
    [
        ...
        9.5e-7,
        70,
        " color='black', size=10, ha='center', va='center', rotation=90",
        1,
        0,
    ],
    ...
    [
        ...
        1.8e-3,
        83,
        " color='black', size=10, ha='center', va='center', rotation=-57",
        1,
        1,
    ],
    [
        ...
        1e-3,
        36,
        " color='black', size=11, ha='center', va='center', rotation=-57",
        1,
        1,
    ],
    [
...
LSWexps = [
    ...
    [
        ...
        3e-3,
        1e-7,
        " color='black', size=10, ha='center', va='center', rotation=45",
        1,
        0,
    ],
    [
...
haloscopes_zoom = [
    [
        ...
        4e-3,
        144,
        " color='black', size=10, ha='center', va='center', rotation=-40",
        1,
        0,
    ],
    ...
    [
        ...
        8.1e-6,
        0.93,
        " color='black', size=8, ha='center', va='top', rotation=90",
        1,
        0,
    ],
    [
    ...
    [
        ...
        2.6e-4,
        16,
        " color='black', size=8, ha='center', va='center', rotation=15",
        1,
        1,
    ],
    [
